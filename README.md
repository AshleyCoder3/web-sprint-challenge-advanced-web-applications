...
* [X] **Make sure that the input for your username and password includes the id="username" and id="password" attributes. Codegrade auto-tests will fail without them.**
...
* [X] **Make sure your error p tag has an id="error" attribute attached. Codegrade auto-tests will fail without them.**
